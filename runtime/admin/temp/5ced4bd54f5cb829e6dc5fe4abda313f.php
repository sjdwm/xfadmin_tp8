                        ...
                        <table class="table table-striped table-bordered">
                            ...
                            <?php if(is_array($vars) || $vars instanceof \think\Collection || $vars instanceof \think\Paginator): $i = 0; $__LIST__ = $vars;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?>
                                <tr>
                                    ...
                                    <td><?php echo htmlentities($val['k']); ?></td>
                                    <td>
                                        {$Think.config.config.<?php echo htmlentities($val['k']); ?>}
                                    </td>
                                    <td><?php echo htmlentities($val['v']); ?></td>
                                    <td><a href="<?php echo url('edit',array('k'=>$val['k'])); ?>"><i
                                            class="ace-icon fa fa-pencil bigger-100"></i>修改</a>&nbsp&nbsp;<a
                                            href="javascript:;" val="<?php echo url('del',array('k'=>$val['k'])); ?>" class="dellink"><i
