                    ...
                    <div class="col-xs-12">
                        ...
                        <form class="form-horizontal" action="<?php echo url('update'); ?>" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="cname" id="name" placeholder="公司名称/部门名称" class="rcol-xs-10 col-sm-5"
                                           value="<?php echo htmlentities($currentmenu['cname']); ?>">
                                    <span class="help-inline col-xs-12 col-sm-7">
												<span class="middle"></span>
											</span>
                                </div>
                            ...
                            <div class="space-4"></div>
                            <div class="form-group">
                                <label class="col-sm-1 control-label no-padding-right" for="form-field-2"> 公司名称EN </label>
                                <div class="col-sm-9">
                                    <input type="text" name="ename" id="ename" placeholder="公司名称/部门名称"
                                           class="col-xs-10 col-sm-5" value="<?php echo htmlentities($currentmenu['ename']); ?>">
                                    <span class="help-inline col-xs-12 col-sm-7">
												<span class="middle"></span>
											</span>
                                </div>
                            ...
                            <div class="space-4"></div>
                              <div class="form-group">
                                <label class="col-sm-1 control-label no-padding-right" for="form-field-2">
                                    部门主管Email </label>
                                <div class="col-sm-9">
                                    <input type="text" name="email" id="email" placeholder="部门主管Email"
                                           class="col-xs-10 col-sm-5" value="<?php echo htmlentities($currentmenu['email']); ?>">
                                    <span class="help-inline col-xs-12 col-sm-7">
                                                <span class="middle"></span>
                                            </span>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="address" id="address" placeholder="公司地址"
                                           class="col-xs-10 col-sm-5" value="<?php echo htmlentities($currentmenu['address']); ?>">
                                    <span class="help-inline col-xs-12 col-sm-7">
												<span class="middle"></span>
											</span>
                                </div>
                            ...
                            <div class="space-4"></div>
                              <div class="form-group">
                                <label class="col-sm-1 control-label no-padding-right" for="form-field-2">
                                    电话 </label>
                                <div class="col-sm-9">
                                    <input type="text" name="phone" id="phone" placeholder="公司电话"
                                           class="col-xs-10 col-sm-5" value="<?php echo htmlentities($currentmenu['phone']); ?>">
                                    <span class="help-inline col-xs-12 col-sm-7">
                                                <span class="middle"></span>
                                            </span>
                                </div>
                            ...
                            <div class="space-4"></div>
                            <div class="form-group">
                                <label class="col-sm-1 control-label no-padding-right" for="form-field-2"> 主管照片</label>
                                <div class="col-sm-9">
