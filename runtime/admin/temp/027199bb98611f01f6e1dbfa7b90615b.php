...
<!-- 
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9" style="padding-top: 6px;">
                                    <?php if($member['id'] == 1): ?>
                                        ...
                                        <input class="ace ace-checkbox-2 children" id="in<?php echo htmlentities($val['id']); ?>" type="checkbox" name="group_ids[]" value="<?php echo htmlentities($val['id']); ?>" <in name="val['id']" value="$usergroup_access"> checked="checked" </in> ><span class="lbl"> <?php echo htmlentities($val['title']); ?></span></label>
                                        &emsp;                    
                                        <?php endforeach; endif; else: echo "" ;endif; ?>
                                    <?php endif; ?>
                                   <!--  <span class="help-inline col-xs-12 col-sm-7">
                            ...
                            <div class="space-4"></div>
                             <div class="form-group">
                                ...
                                <div class="col-sm-2">
                                   <label><input name="lang" type="radio" value="0" checked/>中文 </label>
                                    <label><input name="lang" type="radio" value="1" />英文 </label>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="telphone" id="telphone" placeholder="例：+86 021-64064227-分机号"
                                           class="col-xs-10 col-sm-5" value="<?php echo $member['telphone']=='' ? '+86 021-64064227-分机号' : htmlentities($member['telphone']); ?>">
                                    <span class="help-inline col-xs-12 col-sm-7">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="email" name="email" id="email" placeholder="E-mail"
                                           class="col-xs-10 col-sm-5" value="<?php echo htmlentities($member['email']); ?>" required>
                                    <span class="help-inline col-xs-12 col-sm-7">
												<span class="middle"></span>
											</span>
                                </div>
