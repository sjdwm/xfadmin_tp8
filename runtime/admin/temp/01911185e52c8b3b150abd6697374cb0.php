        ...
        <div class="ace-settings-box clearfix" id="ace-settings-box">
            ...
            <div class="pull-left width-50">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <!-- PAGE CONTENT BEGINS -->
                        <form class="form-horizontal" id="form" role="form" method="post" action="<?php echo url('update'); ?>">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="sitename" id="sitename" placeholder="网站SEO标题"
                                           class="col-xs-10 col-sm-5" value="<?php echo htmlentities(config('config.sitename')); ?>">
                                    <span class="help-inline col-xs-12 col-sm-7">
												<span class="middle">前台调用：{$Think.config.config.sitename}</span>
											</span>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="title" id="title" placeholder="网站标题"
                                           class="col-xs-10 col-sm-5" value="<?php echo htmlentities(config('config.title')); ?>">
                                    <span class="help-inline col-xs-12 col-sm-7">
												<span class="middle">网站标题，前台调用：{$Think.config.config.title}</span>
											</span>
                                </div>
                            </div>
                            <div class="space-4"></div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="keywords" id="keywords" placeholder="关键词"
                                           class="col-xs-10 col-sm-5" value="<?php echo htmlentities(config('config.keywords')); ?>">
                                    <span class="help-inline col-xs-12 col-sm-7">
												<span class="middle">网站关键词，前台调用：{$Think.config.config.keywords}</span>
											</span>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <textarea name="description" id="description" placeholder="网站描述"
                                              class="col-xs-10 col-sm-5" rows="5"><?php echo htmlentities(config('config.description')); ?></textarea>
                                    <span class="help-inline col-xs-12 col-sm-7">
												<span class="middle">网站描述，前台调用：{$Think.config.config.description}</span>
											</span>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <textarea name="footer" id="footer" placeholder="底部内容" class="col-xs-10 col-sm-5"
                                              rows="5"><?php echo htmlentities(config('config.footer')); ?></textarea>
                                    <span class="help-inline col-xs-12 col-sm-7">
												<span class="middle">网站的版权、统计代码等，支持HTML代码，请谨慎使用，前台调用：{$Think.config.config.footer}</span>
											</span>
                                </div>
                            </div>
                            <?php if(is_array($vars) || $vars instanceof \think\Collection || $vars instanceof \think\Paginator): $i = 0; $__LIST__ = $vars;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?>
                                <div class="form-group">
                                    <label class="col-sm-1 control-label no-padding-right" for="form-field-1">
                                        <?php echo htmlentities($val['name']); ?></label>
                                    <div class="col-sm-9">
                                        <input type="text" name="<?php echo htmlentities($val['k']); ?>" id="<?php echo htmlentities($val['k']); ?>" placeholder="变量值"
                                               class="col-xs-10 col-sm-5" value="<?php echo htmlentities($val['v']); ?>">
                                        <span class="help-inline col-xs-12 col-sm-7">
												<span class="middle">自定义变量，前台调用：{$Think.config.config.<?php echo htmlentities($val['k']); ?>}</span>
											</span>
                                    </div>
                                </div>
                                <div class="space-4"></div>
