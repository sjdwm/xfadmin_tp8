                        ...
                        <div class="row">
                            <form class="form-inline" action="" method="post" id="formuser" enctype="multipart/form-data">
                                ...
                                <select name="field" class="form-control">
                                    <option <?php if("app('request')->get('field') == username"): ?>selected<?php endif; ?> value="username">用户名</option>
                                    <option <?php if("app('request')->get('field') == name"): ?>selected<?php endif; ?> value="name">姓名</option>
                                    
                                    <option <?php if("app('request')->get('field') == email"): ?>selected<?php endif; ?> value="email">邮箱</option>
                                </select>
...
<script type="text/javascript">
    $(function () {
        ...
        $(".groupselect").on("change", function () {
            ...
            $.get("<?php echo url('update'); ?>?ajax=yes&uid=" + uid + "&gid=" + gid, function (data) {
