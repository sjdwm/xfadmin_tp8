                                ...
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?>
                                        <tr>
                                            ...
                                            <td><?php echo $val['_name']; ?><?php echo htmlentities($val['title']); ?></td>
                                        ...
                                        <?php if(!(empty($val['children']) || (($val['children'] instanceof \think\Collection || $val['children'] instanceof \think\Paginator ) && $val['children']->isEmpty()))): if(is_array($val['children']) || $val['children'] instanceof \think\Collection || $val['children'] instanceof \think\Paginator): $i = 0; $__LIST__ = $val['children'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
                                                <tr>
                                                    ...
                                                    <td><i class="<?php echo htmlentities($v['icon']); ?>"></i></td>
                                                    <td class="center">
                                                    ...
                                                    <td><?php echo htmlentities($v['o']); ?></td>
                                                    <td class="center"><a href="<?php echo url('edit',array('id'=>$v['id'])); ?>">修改</a>&nbsp;<a
                                                            class="del" href="javascript:;"
                                                            val="<?php echo url('del',array('ids'=>$v['id'])); ?>" title="删除">删除</a></td>
                                                </tr>
                                                <?php if(!(empty($v['children']) || (($v['children'] instanceof \think\Collection || $v['children'] instanceof \think\Paginator ) && $v['children']->isEmpty()))): if(is_array($v['children']) || $v['children'] instanceof \think\Collection || $v['children'] instanceof \think\Paginator): $i = 0; $__LIST__ = $v['children'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vv): $mod = ($i % 2 );++$i;?>
                                                        <tr>
                                                            <td class="center">
                                                                <input class="ids" type="checkbox" name="ids[]"
                                                                       value="<?php echo htmlentities($vv['id']); ?>">
                                                            </td>
                                                            <td>&nbsp;&nbsp;&nbsp;&nbsp;┗━<?php echo htmlentities($vv['title']); ?></td>
                                                            <td><?php echo htmlentities($vv['name']); ?></td>
                                                            <td><i class="<?php echo htmlentities($vv['icon']); ?>"></i></td>
                                                            <td class="center">
                                                            ...
                                                            <td><?php echo htmlentities($vv['o']); ?></td>
                                                            <td class="center"><a
                                                                    href="<?php echo url('edit',array('id'=>$vv['id'])); ?>">修改</a>&nbsp;<a
                                                                    class="del" href="javascript:;"
                                                                    val="<?php echo url('del',array('ids'=>$vv['id'])); ?>" title="删除">删除</a>
                                                            </td>
                                                        </tr>
                                                    <?php endforeach; endif; else: echo "" ;endif; ?>
                                                <?php endif; ?>
