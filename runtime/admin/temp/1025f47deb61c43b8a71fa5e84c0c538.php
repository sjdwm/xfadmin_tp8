<?php /*a:2:{s:41:"D:\www\tp\app\Admin\view\login\index.html";i:1698229940;s:41:"D:\www\tp\app\Admin\view\Public\head.html";i:1699858880;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
                            ...
                            <div class="widget-body">
                                <div class="widget-main">
                                    <h4 class="header blue lighter bigger">
                                        ...
                                        <b><?php echo htmlentities($web_config['sitename']); ?></b>
                                    </h4>
                                            ...
                                            <label class="block clearfix">
														<span class="block input-icon ">
															<span class="inline"><input type="text" class="form-control"
                                                                                        ...
                                                                                        id="code" required autocomplete="off"/></span>
                                                                                        <div><?php echo captcha_img(); ?></div>
															<!-- <img style="cursor:pointer;" src="<?php echo url('login/verify'); ?>"
                                                                 width="100" height="30" title="看不清楚？点击刷新"
                                                                 onclick="this.src = '<?php echo url('login/verify'); ?>?'+new Date().getTime()"> -->
														</span>
                                            </label>
...
<!--[if IE]>
<script type="text/javascript">
    window.jQuery || document.write("<script src='/static/qwadmin/js/jquery1x.js'>" + "<" + "/script>");
</script>
<![endif]-->
<script type="text/javascript">
