            ...
            <div class="pull-left width-50">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <!-- PAGE CONTENT BEGINS -->
                        <div class="cf">
                            <a class="btn btn-info" href="<?php echo url('add'); ?>" value="">新增链接</a>
                        </div>
                                ...
                                <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?>
                                    <tr>
                                        <td class="center"><input class="ids" type="checkbox" name="ids[]"
                                                                  value="<?php echo htmlentities($val['id']); ?>"></td>
                                        <td><a href="<?php echo htmlentities($val['url']); ?>" target="_blank"><?php echo htmlentities($val['title']); ?></a></td>
                                        <td>
                                            <?php if($val['logo'] != ''): ?><img src="/<?php echo htmlentities($val['logo']); ?>"
                                                                                     width="88" height="31">
                                                <?php else: ?>
                                                文本链接
                                            <?php endif; ?>
                                        </td>
                                        <td><a href="<?php echo htmlentities($val['url']); ?>" target="_blank"><?php echo htmlentities($val['url']); ?></a></td>
                                        <td><?php echo htmlentities($val['o']); ?></td>
                                        <td><a href="<?php echo url('edit',array('id'=>$val['id'])); ?>"><i
                                                class="ace-icon fa fa-pencil bigger-100"></i>修改</a>&nbsp&nbsp;<a
                                                href="javascript:;" val="<?php echo url('del',array('ids'=>$val['id'])); ?>"
