            ...
            <div class="pull-left width-50">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <div class="row">
                            <div class="cf">
                                <a class="btn btn-info" href="<?php echo url('authadd'); ?>" value="">新增</a>
                            </div>
                            <div class="space-4"></div>
                            <form id="form" method="post" action="<?php echo url('htdel'); ?>">
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?>
                                        <tr id="c<?php echo htmlentities($val['id']); ?>" c<?php echo htmlentities($val['id']); ?>="0"  onclick="show(<?php if($val['pid'] == '0'): ?><?php echo htmlentities($val['id']); ?><?php endif; ?>);" class="xshow <?php if($val['pid'] != '0'): ?>cshow<?php endif; ?>">
                                            ...
                                            <td><?php if($val['pid'] == '0'): ?><i id="d<?php echo htmlentities($val['id']); ?>" class="menu-icon fa fa-angle-right biao"></i><?php endif; ?> &nbsp;<?php echo $val['_name']; ?><?php echo htmlentities($val['title']); ?></td>
                                            ...
                                            <td class="center">
                                            <a class="green" href="<?php echo url('authadd',array('pid'=>$val['id'])); ?>"
                                                     title="新增分类"><i class="ace-icon fa fa-plus-circle bigger-100"></i>新增</a>&nbsp;&nbsp;
                                            <a class="blue" href="<?php echo url('authedit',array('id'=>$val['id'])); ?>"><i class="ace-icon fa fa-plus-circle bigger-100"></i>修改</a>&nbsp;<a
                                                    class="red del" href="javascript:;" val="<?php echo url('htdel',array('ids'=>$val['id'])); ?>"
