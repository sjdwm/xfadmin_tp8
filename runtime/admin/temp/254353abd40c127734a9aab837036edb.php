        ...
        <div class="ace-settings-box clearfix" id="ace-settings-box">
            ...
            <div class="pull-left width-50">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <!-- PAGE CONTENT BEGINS -->
                        <form class="form-horizontal" id="form" method="post" action="<?php echo url('update',array('id'=>$link['id'])); ?>">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="title" id="title" placeholder="标题"
                                           class="col-xs-10 col-sm-5" value="<?php echo htmlentities($link['title']); ?>">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="url" name="url" id="url" placeholder="链接地址" class="col-xs-10 col-sm-5"
                                           value="<?php echo htmlentities($link['url']); ?>">
                                    <span class="help-inline col-xs-12 col-sm-7">
                            ...
                            <div class="form-group">
                                <label class="col-sm-1 control-label no-padding-right" for="form-field-4">
                                    网站LOGO </label>
                                <div class="col-sm-9">
                                    <div class="col-xs-10 col-sm-5"><button type="button" class="layui-btn" id="test11">
                                            <i class="layui-icon">&#xe67c;</i>上传图片
                                        </button>
                                        <img id='img' src="<?php echo htmlentities($article['thumbnail']); ?>" alt="" style="width: 100px;height: 100px;"></div>
                                    <span class="help-inline col-xs-12 col-sm-7">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" name="o" id="o" placeholder="排序" class="col-xs-10 col-sm-5"
                                           value="<?php echo htmlentities($link['o']); ?>">
                                    <span class="help-inline col-xs-12 col-sm-7">
...
up_img("<?php echo url('Link/upimg'); ?>",'#test11');
    $(function () {
