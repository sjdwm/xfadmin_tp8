        ...
        <div class="ace-settings-box clearfix" id="ace-settings-box">
            ...
            <div class="pull-left width-50">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <!-- PAGE CONTENT BEGINS -->
                        <form class="form-horizontal" action="<?php echo url('authupdate'); ?>" method="post">
                            ...
                            <!-- <div class="space-4"></div>
                            <div class="form-group">
                                <label class="col-sm-1 control-label no-padding-right" for="form-field-1"> 菜单名称(英文) </label>
                                <div class="col-sm-9">
                                    <input type="text" name="ename" id="ename" class="rcol-xs-10 col-sm-5"
                                           value="<?php echo htmlentities($currentmenu['ename']); ?>">
                                    <span class="help-inline col-xs-12 col-sm-7">
                                                <span class="middle"></span>
                                            </span>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="name" id="name" placeholder="链接，如：Admin/Index/index"
