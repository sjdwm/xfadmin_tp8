        ...
        <div class="ace-settings-box clearfix" id="ace-settings-box">
            ...
            <div class="pull-left width-50">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <!-- PAGE CONTENT BEGINS -->
                        <form class="form-horizontal" id="form" name="form" action="<?php echo url('update'); ?>" method="post">
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="title" id="title" placeholder="用户组名"
                                           class="col-xs-10 col-sm-5" value="<?php echo htmlentities($group['title']); ?>">
                                    <input type="hidden" name="id" id="id" value="<?php echo htmlentities($group['id']); ?>">
                            ...
                            <?php if($group['id'] != 1): ?>
                                                    ...
                                                    <div class="widget-box">
                                                        <div class="widget-header">
                                                            <h4 class="widget-title">
                                                                <label>
                                                                    <input name="rules[]" 
                                                                           class="ace ace-checkbox-2 father" <?php if(in_array($v['id'],$group['rules'])): ?>checked="checked"<?php endif; ?> 
                                                                    type="checkbox" value="<?php echo htmlentities($v['id']); ?>"/>
                                                                    <span class="lbl"> <?php echo htmlentities($v['title']); ?></span>
                                                                </label>
                                                            </h4>
                                                            <div class="widget-toolbar">
                                                                <?php if(!(empty($v['_data']) || (($v['_data'] instanceof \think\Collection || $v['_data'] instanceof \think\Paginator ) && $v['_data']->isEmpty()))): ?>
                                                        ...
                                                        <?php if(!(empty($v['_data']) || (($v['_data'] instanceof \think\Collection || $v['_data'] instanceof \think\Paginator ) && $v['_data']->isEmpty()))): ?>
                                                            <div class="widget-body">
                                                                <div class="widget-main row">
                                                                    <?php if(is_array($v['_data']) || $v['_data'] instanceof \think\Collection || $v['_data'] instanceof \think\Paginator): $i = 0; $__LIST__ = $v['_data'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vv): $mod = ($i % 2 );++$i;?>
                                                                        <label class="col-xs-2" style="width:160px;">
                                                                            <input name="rules[]"
                                                                                   class="ace ace-checkbox-2 children" <?php if(in_array($vv['id'],$group['rules'])): ?>checked="checked"<?php endif; ?>
                                                                            type="checkbox" value="<?php echo htmlentities($vv['id']); ?>"/>
                                                                            <span class="lbl"> <?php echo htmlentities($vv['title']); ?></span>
                                                                        </label>
                                                                        <?php if(is_array($vv['_data']) || $vv['_data'] instanceof \think\Collection || $vv['_data'] instanceof \think\Paginator): $i = 0; $__LIST__ = $vv['_data'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vvv): $mod = ($i % 2 );++$i;?>
                                                                            <label class="col-xs-2"
                                                                                   style="width:160px;">
                                                                                <input name="rules[]"
                                                                                       class="ace ace-checkbox-2 children" <?php if(in_array($vvv['id'],$group['rules'])): ?>checked="checked"<?php endif; ?>
                                                                                type="checkbox" value="<?php echo htmlentities($vvv['id']); ?>"/>
                                                                                <span class="lbl"> <?php echo htmlentities($vvv['title']); ?></span>
                                                                            </label>
                                                                        <?php endforeach; endif; else: echo "" ;endif; ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="col-sm-10">
                                            <?php if(is_array($hrule) || $hrule instanceof \think\Collection || $hrule instanceof \think\Paginator): $i = 0; $__LIST__ = $hrule;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
                                                <div class="row">
                                                    <div class="widget-box">
                                                        <div class="widget-header">
                                                            <h4 class="widget-title">
