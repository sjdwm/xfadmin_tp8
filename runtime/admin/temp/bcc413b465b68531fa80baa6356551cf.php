        ...
        <div class="ace-settings-box clearfix" id="ace-settings-box">
            ...
            <div class="pull-left width-50">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <!-- PAGE CONTENT BEGINS -->
                        <form id="export-form" method="post" action="<?php echo url('del'); ?>">
                                    ...
                                    <tr>
                                        <td class="center">
                                            <?php if($val['id'] != 1): ?><input class="ids" type="checkbox"
                                                                                    name="ids[]" value="<?php echo htmlentities($val['id']); ?>">
                                                <?php else: ?>
                                        ...
                                        <td>
                                            <?php if($val['id'] == 1): ?> 启用
                                            <?php elseif($val['status'] == 1): ?><a href="<?php echo url('status',array('id'=>$val['id'])); ?>" title="点击禁用">启用</a>
                                                <?php else: ?>
                                                <a href="<?php echo url('status',array('id'=>$val['id'])); ?>" title="点击启用">禁用</a>
                                            <?php endif; ?>
                                        </td>
                                        <td class="center"><a class="bbtn bbtn-info" href="<?php echo url('edit',array('id'=>$val['id'])); ?>">修改权限</a> 
                                        <a class="bbtn bbtn-info" href="<?php echo url('usergroup',array('id'=>$val['id'])); ?>">添加人员</a></td>
