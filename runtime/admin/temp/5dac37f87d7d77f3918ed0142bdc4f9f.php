                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="cf">
                            <form class="form-inline" action="" method="get">
                                <a class="btn btn-info" href="<?php echo url('add'); ?>" value="">新增</a>
                                ...
                                <input type="text" name="keyword" value="<?php echo input('get.keyword'); ?>" class="form-control">

                                <label class="inline">&nbsp;&nbsp;文章排序：</label>
                                <select name="order" class="form-control">
                                    <option value="desc" <?php if(input('get.order') == 'desc'): ?>selected<?php endif; ?>>发布时间降序</option>
                                    <option value="asc" <?php if(input('get.order') == 'asc'): ?>selected<?php endif; ?> >发布时间升序</option>
                        ...
                        <form id="form" method="post" action="<?php echo url('del'); ?>">
                                ...
                                <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?>
                                    <tr>
                                        <td class="center"><input class="aids" type="checkbox" name="aids[]"
                                                                  value="<?php echo htmlentities($val['aid']); ?>"></td>
                                        <td><?php echo htmlentities($val['aid']); ?></td>
                                        <td><a href="<?php echo url('Home/Index/article',array('aid'=>$val['aid'])); ?>" title="<?php echo htmlentities($val['name']); ?>"><?php echo htmlentities($val['s_name']); ?> <?php echo htmlentities($val['name']); ?></a>
                                        </td>
                                        <td><?php echo !empty($val['title']) ? htmlentities($val['title']) : htmlentities($val['title_en']); ?></td>
                                        <td><?php echo member($val['uid'],'username')['username']; ?></td>
                                        <td class="center"><div id="bt<?php echo htmlentities($val['aid']); ?>" onClick="redoit(<?php echo htmlentities($val['aid']); ?>,'bt<?php echo htmlentities($val['aid']); ?>','is_show')" class="<?php echo $val['is_show']=='1' ? 'glyphicon glyphicon-ok' : 'glyphicon glyphicon-remove'; ?> ds" <?php echo $val['is_show']=='1' ? 'style="color : #089641;"':'style="color:red;"'; ?> > </div></td>
                                        <td class="center"><div id="btt<?php echo htmlentities($val['aid']); ?>" onClick="redoit(<?php echo htmlentities($val['aid']); ?>,'btt<?php echo htmlentities($val['aid']); ?>','is_top')" class="<?php echo $val['is_top']=='1' ? 'glyphicon glyphicon-ok' : 'glyphicon glyphicon-remove'; ?> ds" <?php echo $val['is_top']=='1' ? 'style="color : #089641;"':'style="color:red;"'; ?> > </div></td>
                                        <td class="center"><div id="bttt<?php echo htmlentities($val['aid']); ?>" onClick="redoit(<?php echo htmlentities($val['aid']); ?>,'bttt<?php echo htmlentities($val['aid']); ?>','is_s')" class="<?php echo $val['is_s']=='1' ? 'glyphicon glyphicon-ok' : 'glyphicon glyphicon-remove'; ?> ds" <?php echo $val['is_s']=='1' ? 'style="color : #089641;"':'style="color:red;"'; ?> > </div></td>
                                        <td class="center"><?php echo htmlentities($val['click']); ?></td>
                                        <td><?php echo date("Y-m-d H:i:s",$val['time']); ?></td>
                                        <td><a href="<?php echo url('edit',array('aid'=>$val['aid'])); ?>"><i
                                                class="ace-icon fa fa-pencil bigger-100"></i>修改</a>&nbsp&nbsp;<a
                                                href="javascript:;" val="<?php echo url('del',array('aids'=>$val['aid'])); ?>" class="del"><i
