  ...
  <section class="section">
    ...
    <form id="J_install_form" action="index.php?step=4" method="post">
      ...
      <div class="server">
        <table width="100%">
          ...
          <tr>
            ...
            <td><input type="text" name="dbname" id="dbname" value="xfadmin" class="input"></td>
            <td><div id="J_install_tip_dbname"></div></td>
          </tr>
          <tr>
            <td class="tar">数据库表前缀：</td>
            <td><input type="text" name="dbprefix" id="dbprefix" value="xf_" class="input" ></td>
            <td><div id="J_install_tip_dbprefix"><span class="gray">建议使用默认，同一数据库安装多个项目时需修改</span></div></td>
          </tr>
          <tr>
        ...
        <table width="100%">
          <tr>
            ...
            <td class="td1" width="200">&nbsp;登录地址:localhost/admin</td>
            <td class="td1">&nbsp;</td>
          </tr>
          <tr>
            <td class="tar">管理员帐号：</td>
            <td><input type="text" name="manager" id="manager" value="admin" disabled class="input"></td>
            <td><div id="J_install_tip_manager"></div></td>
          </tr>
          <tr>
            <td class="tar">管理员密码：</td>
            <td><input type="text" name="manager_pwd" id="manager_pwd" value="admin" disabled class="input" autoComplete="off"></td>
      ...
      <div class="bottom tac"> <a href="./index.php?step=2" class="btn">上一步</a>
        <button type="button" onClick="TestDbPwd(1);" class="btn btn_submit J_install_btn">创建数据</button>
      </div>
    </form>
  </section>
